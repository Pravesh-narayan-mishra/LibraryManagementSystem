...
<html>
    <head>
        <title>Book Record Deletion Form</title>
        <style>
          .
          {
              padding :0px;
    ...
    <body>
        <div class="menu">
            <h2>Book Record Deletion Form</h2>
        </div>

        <div id="bookRecordDeletionForm">
            <form action="http://localhost/gitHub/libraryManagementSystem/bookdeletion.php"method="POST">
                <table id="tb1">
                    <tr>
                        <th>Book Id</th>
                        <th>Course</th>
                    ...
                    for($i=1;$i<=$num;$i++)
                    {
                        ...
                        <tr>
                           ...
                           <td><input type="checkbox"name="b<?php echo $i;?>"value="<?php echo $row['b_id'];?>"/></td>
                        </tr>
                        <?php
                    }
                    ?>
                    <tr>
                        <td colspan="5"align="center"><input type="submit"value="Delete selected Data"/></td>
                    </tr>
                </table>
            </form>
            ...
            <input type="text"id="insertData"onkeyup="checkSearch()"/>
            </div>
            <script>
                function checkSearch()
                {
                    var insert=document.getElementById('insertData').value.toUpperCase();
